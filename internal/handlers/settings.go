...
func ChangePassword(c *gin.Context) {
	...
	// Invalidate all API keys — if the password was changed because the
	// account was compromised, any keys generated by the attacker must stop
	// working too (matching ResetPassword's behaviour in auth.go).
